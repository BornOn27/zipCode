package com.flodeus.spring.zipCode.config;
...
public class SwaggerConfig {
    ...
    private static final Contact DEFAULT_CONTACT = new Contact(
            "Flodeus",
            "",
            "flodeus.feedback@gmail.com");
    private static final ApiInfo DEFAULT_AP_INFO = new ApiInfo(
            "ZipCode Api Documentation",
            "ZipCode Api Documentation",
            "1.0",
            "urn:tos",
            DEFAULT_CONTACT,
